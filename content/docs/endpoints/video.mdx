...
description: Generate videos from text, images, or reference videos using the Glowey API.
---
...
Varies by model, duration, and resolution. See [Credits & Pricing](/docs/credits-and-pricing#video-generation).

Example: Seedance 2.0 Fast, 5s, 720p = (12 + 5x3) x 1.25 = 57 credits.
...
```json
{
  ...
  "taskId": "task_h4i5j6k7",
  "output": {
    "video_url": "https://storage.gloweyai.com/video_xyz789.mp4",
    "cover_image_url": "https://storage.gloweyai.com/cover_xyz789.jpg"
  }
}
```
...
```bash
curl "https://gloweyai.com/api/video/status?taskId=task_h4i5j6k7" \
  -H "Authorization: Bearer glow_sk_YOUR_TOKEN_HERE"
```
...
See [Credits & Pricing](/docs/credits-and-pricing#video-generation) for complete list.
