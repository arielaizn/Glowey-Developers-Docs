---
title: Rate Limiting
description: API rate limits, retry behavior, and best practices for the Glowey API.
---
...
Enterprise customers can request higher limits via email: [api@gloweyai.com](mailto:api@gloweyai.com)
