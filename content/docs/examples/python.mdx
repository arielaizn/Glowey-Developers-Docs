...
def generate_image():
    ...
    while True:
        ...
        status_res = requests.get(
            f'https://gloweyai.com/api/generate/status?taskId={task_id}',
            headers={'Authorization': f'Bearer {token}'}
        )
...
class GloweyClient:
    def __init__(self, token):
        self.token = token
        self.base_url = 'https://gloweyai.com/api'
        self.headers = {
            'Authorization': f'Bearer {token}',
            'Content-Type': 'application/json',
        }
...
def generate_video():
    ...
    # Submit
    res = requests.post(
        'https://gloweyai.com/api/video/generate',
        headers={'Authorization': f'Bearer {token}'},
        json={
    ...
    while True:
        time.sleep(5)
        status = requests.get(
            f'https://gloweyai.com/api/video/status?taskId={task_id}',
            headers={'Authorization': f'Bearer {token}'}
        ).json()
...
def generate_music():
    ...
    # Submit
    res = requests.post(
        'https://gloweyai.com/api/audio/music',
        headers={'Authorization': f'Bearer {token}'},
        json={
    ...
    while True:
        time.sleep(10)
        status = requests.get(
            f'https://gloweyai.com/api/audio/music/status?taskId={task_id}',
            headers={'Authorization': f'Bearer {token}'}
        ).json()
...
def generate_sfx():
    ...
    res = requests.post(
        'https://gloweyai.com/api/audio/sfx',
        headers={'Authorization': f'Bearer {token}'},
        json={
