...
Tokens are created in [gloweyai.com/me/settings](https://gloweyai.com/me/settings) and follow the format:
...
```javascript
fetch('https://gloweyai.com/api/generate', {
  method: 'POST',
  headers: {
...
- **Create:** [gloweyai.com/me/settings](https://gloweyai.com/me/settings) → Developer API → Create token
